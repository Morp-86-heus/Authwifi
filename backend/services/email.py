...
_HTML = (
    ...
    '<h1 style="margin:0 0 10px;font-size:22px;font-weight:700;color:#111;line-height:1.3">'
    'Ciao __NAME__,</h1>'
    '<p style="margin:0 0 28px;font-size:15px;color:#555;line-height:1.65">__BODY__</p>'
    ...
    'text-transform:uppercase;letter-spacing:.8px">Da 0 a 10, quanto ci consiglieresti?</p>'
